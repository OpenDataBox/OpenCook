...
from code_agent.tools.base import Tool, ToolCall
from code_agent.utils.config import ModelConfig
from code_agent.utils.llm_clients.base_client import BaseLLMClient
from code_agent.utils.llm_clients.llm_basics import LLMMessage, LLMResponse, LLMUsage
...
class OpenAICompatibleClient(BaseLLMClient):
    ...
    def should_retry(self, exc: Exception) -> bool:
        ...
        if isinstance(exc, openai.AuthenticationError):   # 401
            return False
        if isinstance(exc, openai.PermissionDeniedError): # 403
            return False
        if isinstance(exc, openai.NotFoundError):         # 404
            return False
        return True
    ...
    def _create_response(
        ...
        # print("message_history:", self.message_history)l
        # with open("/data/wei/program/DBCooker/message_history.pickle", "wb") as wf:
        #     pickle.dump(self.message_history, wf)

        # # TOOD: to be removed.
        # self.message_history.append(
        #     {
        #         "role": "user",
        #         "content": "Please remember to effectively utilize the provided plans to reduce the steps "
        #                    "to explore the database and place the implementation in the correct source files. "
        #                    "Assume that all the required functions are not implemented and "
        #                    "do not waste steps to verify whether the existence."
        #     }
        # )
        ...
        response = self.client.chat.completions.create(
            ...
            # top_p=model_config.top_p if model_config.model != "claude_sonnet4_5" else openai.NOT_GIVEN,
        ...
        # # TODO: to be removed.
        # with open('/data/wei/program/DBCooker/results/response_sqlite.pkl', 'wb') as file:
        #     pickle.dump(response, file)

        # with open('/data/wei/program/DBCooker/results/response_sqlite.pkl', 'rb') as file:
