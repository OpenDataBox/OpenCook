...
class GoogleClient(BaseLLMClient):
    ...
    def should_retry(self, exc: Exception) -> bool:
        ...
        try:
            ...
            if isinstance(exc, (InvalidArgument, Unauthenticated, PermissionDenied, NotFound)):
                return False
        except ImportError:
            pass
        return True
    ...
    def chat(
        ...
        # If the asyncio task was cancelled while blocked, skip all state
        # mutations and trajectory recording so message_history and the
        # trajectory file are not polluted with data from the interrupted turn.
